...
TEST(RookMoveTest, RookEnemyPiece) {
    ...
    b->chess_board[3][5] = new Pawn(Piece::PieceColour::BLACK);
    ASSERT_TRUE(b->is_valid_move(rw, {3, 3}, {3, 5}));
    delete rw;


    auto *rb = new Rook(Piece::PieceColour::BLACK);
    b->chess_board[3][5] = new Pawn(Piece::PieceColour::WHITE);
    ASSERT_TRUE(b->is_valid_move(rb, {3, 3}, {3, 5}));
    delete rb;
...
TEST(RookMoveTest, RookFriendlyPiece) {
    ...
    b->chess_board[3][5] = new Pawn(Piece::PieceColour::WHITE);
    ASSERT_FALSE(b->is_valid_move(rw, {3, 3}, {3, 5}));
    delete rw;

    auto *rb = new Rook(Piece::PieceColour::BLACK);
    b->chess_board[3][5] = new Pawn(Piece::PieceColour::BLACK);
    ASSERT_FALSE(b->is_valid_move(rb, {3, 3}, {3, 5}));
    delete rb;
...
TEST(RookMoveTest, RookBoundsTest) {
    ...
    ASSERT_FALSE(b->is_valid_move(rw, {3, 3}, {-1, 3}));
    ASSERT_FALSE(b->is_valid_move(rw, {3, 3}, {8, 3}));
    ASSERT_FALSE(b->is_valid_move(rw, {3, 3}, {3, -1}));
    ASSERT_FALSE(b->is_valid_move(rw, {3, 3}, {3, 8}));
